	...
	class SD_Register_Post_Type {
		...
		private function set_defaults() {
			...
			$this->defaults['labels'] = array(
				...
				'add_new_item' => 'Añadir nuevo ' . $post_type,
				'edit_item' => 'Editar ' . $post_type,
				'new_item' => 'Nuevo ' . $post_type,
				'view_item' => 'Ver ' . $post_type,
				'search_items' => 'Buscar ' . $plural,
				'not_found' => 'Ningun ' . $plural . ' Encontrado',
				'not_found_in_trash' => 'Ningun ' . $plural . ' Encontrado en la basura'
			);
		}
...
sd_register_post_type( 'asociados' );
register_taxonomy("plataforma", array("asociados"), array("hierarchical" => true, "label" => "Plataforma", "singular_label" => "Plataforma", "rewrite" => true));
?>