...
wp_enqueue_script('easi',get_template_directory_uri().'/js/jquery.easing.1.3.js');
wp_enqueue_script('mobilecustomized',get_template_directory_uri().'/js/jquery.mobile.customized.min.js');
